Namespace Items.XItems
    ...
    Public Class XSpeed
        ...
        Public Overrides ReadOnly Property Description As String = "An item that sharply boosts the Speed stat of a Pokémon during a battle. It wears off once the Pokémon is withdrawn."
