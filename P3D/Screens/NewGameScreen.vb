Public Class NewGameScreen
    ...
    Private Sub LoadIntroValues()
        ...
        If Me.Dialogues.Count < 3 Then
            Me.Dialogues.Clear()
            Me.Dialogues.AddRange({Localization.Translate("dialog.new_game.oak_1"), Localization.Translate("dialog.new_game.oak_2"), Localization.Translate("dialog.new_game.oak_3")})
        End If
    End Sub
    ...
    Public Overrides Sub Draw()
        ...
        Select Case Index
            Case 5
                Core.SpriteBatch.DrawString(FontManager.MiniFont, Localization.Translate("dialog.new_game.your_name") & ":", New Vector2(TextboxPosition.X, TextboxPosition.Y - 24), Color.White)
                DrawTextBox()

                If enterCorrectName = True Then
                    Core.SpriteBatch.DrawString(FontManager.MiniFont, Localization.Translate("dialog.new_game.name_too_short"), New Vector2(TextboxPosition.X, TextboxPosition.Y + 30), Color.DarkRed)
                End If
            Case 4
                Canvas.DrawRectangle(New Rectangle(CInt(TextboxPosition.X - 5), CInt(TextboxPosition.Y - 24), 138, 42), New Color(0, 0, 0, 80))

                Core.SpriteBatch.DrawString(FontManager.MiniFont, Localization.Translate("dialog.new_game.choose_skin") & ":" & Environment.NewLine & skinNames(SkinIndex), New Vector2(TextboxPosition.X, TextboxPosition.Y - 24), Color.White)
    ...
    Private Function NameReaction(ByVal name As String) As String
        ...
        Select Case True
            Case WeirdNames.Contains(name.ToLower())
                Return Localization.Translate("dialog.new_game.oak_weird_name_1") & name & Localization.Translate("dialog.new_game.oak_weird_name_2")
            Case KnownNames.Contains(name.ToLower())
                Return Localization.Translate("dialog.new_game.oak_known_name_1") & name & Localization.Translate("dialog.new_game.oak_known_name_2")
            Case OwnNames.Contains(name.ToLower())
                Return Localization.Translate("dialog.new_game.oak_same_name_1") & name & Localization.Translate("dialog.new_game.oak_same_name_2")
        End Select

        Return Localization.Translate("dialog.new_game.oak_name_1") & name & Localization.Translate("dialog.new_game.oak_name_2")
    End Function
End Class