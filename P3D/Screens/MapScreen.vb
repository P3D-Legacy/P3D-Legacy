Public Class MapScreen
    ...
    Private Sub DrawSwitch()
        ...
        Core.SpriteBatch.DrawString(FontManager.MiniFont, Localization.Translate("map_screen.cities"), New Vector2(Core.windowSize.Width - 139, 101), Color.Black)
        Core.SpriteBatch.DrawString(FontManager.MiniFont, Localization.Translate("map_screen.cities"), New Vector2(Core.windowSize.Width - 140, 100), Color.White)
        ' Routes:
        ...
        Core.SpriteBatch.DrawString(FontManager.MiniFont, Localization.Translate("map_screen.routes"), New Vector2(Core.windowSize.Width - 139, 131), Color.Black)
        Core.SpriteBatch.DrawString(FontManager.MiniFont, Localization.Translate("map_screen.routes"), New Vector2(Core.windowSize.Width - 140, 130), Color.White)
        ' Places:
        ...
        Core.SpriteBatch.DrawString(FontManager.MiniFont, Localization.Translate("map_screen.places"), New Vector2(Core.windowSize.Width - 139, 161), Color.Black)
        Core.SpriteBatch.DrawString(FontManager.MiniFont, Localization.Translate("map_screen.places"), New Vector2(Core.windowSize.Width - 140, 160), Color.White)
        ' Roaming:
        ...
        Core.SpriteBatch.DrawString(FontManager.MiniFont, Localization.Translate("map_screen.roaming"), New Vector2(Core.windowSize.Width - 139, 191), Color.Black)
        Core.SpriteBatch.DrawString(FontManager.MiniFont, Localization.Translate("map_screen.roaming"), New Vector2(Core.windowSize.Width - 140, 190), Color.White)
    End Sub
