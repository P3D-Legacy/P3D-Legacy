Public Class ApricornScreen
    ...
    Private Sub InitializeScreen()
        If Me.lastUpdateState <> Me.State Then
            ...
            Me.Labels.Add(New Label(Localization.Translate("apricorn_screen.apricorns"), New Vector2(80, 128), FontManager.MainFont))

            Select Case Me.State
                Case States.Wait
                    Me.Labels.Add(New Label(Localization.Translate("apricorn_screen.producing").Replace("~", Environment.NewLine), New Vector2(100, 200), FontManager.MainFont))
                    Me.Labels.Add(New Label(Localization.Translate("apricorn_screen.backadvice"), New Vector2(100, 260), Color.DarkGray, FontManager.MainFont))
                Case States.CanGive
                    Dim T As Texture2D = TextureManager.GetTexture("Items\ItemSheet")

                    Me.Labels.Add(New Label(Localization.Translate("apricorn_screen.choose_apricorns"), New Vector2(100, 200), FontManager.MainFont))
                    ...
                    Dim GiveButton As ButtonIcon = New ButtonIcon(AddressOf Me.Give, Localization.Translate("apricorn_screen.ok"), FontManager.MainFont, mainTexture, New Rectangle(48, 128, 16, 16), New Vector2(162, 496), New Size(48, 48), "OK")
                    GiveButton.Enabled = False
                    Dim ClearButton As ButtonIcon = New ButtonIcon(AddressOf Me.ClearApricorns, Localization.Translate("apricorn_screen.clear"), FontManager.MainFont, mainTexture, New Rectangle(64, 128, 16, 16), New Vector2(162, 432), New Size(48, 48), "Clear")
                ...
                Case States.CanTake
                    Dim TakeButton As ButtonIcon = New ButtonIcon(AddressOf Me.Take, Localization.Translate("apricorn_screen.take"), FontManager.MainFont, mainTexture, New Rectangle(48, 128, 16, 16), New Vector2(98, 450), New Size(48, 48))
                    Buttons.AddRange({TakeButton})
                    Me.Labels.Add(New Label(Localization.Translate("apricorn_screen.ready"), New Vector2(100, 200), FontManager.MainFont))
            End Select
        End If
    End Sub
    ...
    Private Sub Take()
        ...
        Dim text As String = Core.Player.Name & Localization.Translate("apricorn_screen.obtain")
