...
Public Class NewInventoryScreen
    ...
    Public Overrides Sub Update()
        ...
        If _tossingItems Then
            Dim cItem As Item = Item.GetItemByID(_items(ItemIndex + PageIndex * 10).ItemID)
            If Controls.Right(True, True, True, True) OrElse Controls.Up(True, True, True, True) Then
                _tossValue += 1
            End If
            If Controls.Left(True, True, True, True) OrElse Controls.Down(True, True, True, True) Then
                _tossValue -= 1
            End If
