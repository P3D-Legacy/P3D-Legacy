    ...
    Public Class NewNewGameScreen
        ...
        Public Class CharacterSelectionScreen
            ...
            Public Overrides Sub Draw()
                ...
                SpriteBatch.DrawString(FontManager.MainFont, Localization.Translate("select_appearance"), New Vector2(windowSize.Width / 2.0F - FontManager.MainFont.MeasureString(Localization.Translate("select_apperance")).X + 2, 100 + 2), New Color(0, 0, 0, CInt(255 * _fadeIn)), 0F, Vector2.Zero, 2.0F, SpriteEffects.None, 0F)
                SpriteBatch.DrawString(FontManager.MainFont, Localization.Translate("select_appearance"), New Vector2(windowSize.Width / 2.0F - FontManager.MainFont.MeasureString(Localization.Translate("select_apperance")).X, 100), New Color(255, 255, 255, CInt(255 * _fadeIn)), 0F, Vector2.Zero, 2.0F, SpriteEffects.None, 0F)
