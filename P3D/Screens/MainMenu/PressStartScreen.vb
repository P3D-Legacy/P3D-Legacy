        ...
        If _fadeInMain = 0F Then
            If IsCurrentScreen() And Core.GameOptions.ShowGUI Then  ' Want to implement fading of text, but core doesn't seem to support this.
                ...
                If ControllerHandler.IsConnected() AndAlso Core.GameOptions.GamePadEnabled = True Then
                    SpriteBatch.Draw(TextureManager.GetTexture("GUI\GamePad\xboxControllerButtonA"), New Rectangle(CInt(windowSize.Width / 2 - textSize.X / 2 + textSizeUntilButton.X + FontManager.InGameFont.MeasureString(" ").X - 2), CInt(windowSize.Height - textSize.Y / 2 - 50 - 16), 32, 32), Color.White)
                End If
            End If
        End If
