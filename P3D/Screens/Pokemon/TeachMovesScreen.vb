    ...
    Public Overrides Sub Draw()
        ...
        If Me.MovesList.Count > 0 Then
            ...
            With Core.SpriteBatch
                Dim Description As String = A.Description.Replace("’", "'").CropStringToWidth(FontManager.MainFont, 188)
    ...
    Private Sub DrawAttack(ByVal x As Integer, ByVal i As Integer, ByVal A As BattleSystem.Attack, ByVal isLearnMove As Boolean)
        ...
        With Core.SpriteBatch
            ...
            If c <> Color.Black Then
                .DrawString(FontManager.MainFont, Localization.GetString("property_PP", "PP") & " " & A.CurrentPP & " / " & A.MaxPP, New Vector2(p.X + 96 - 34 + 2, CInt(p.Y + 56 + 2)), Color.Black)
            End If
            .DrawString(FontManager.MainFont, Localization.GetString("property_PP", "PP") & " " & A.CurrentPP & " / " & A.MaxPP, New Vector2(p.X + 96 - 34, CInt(p.Y + 56)), c)
