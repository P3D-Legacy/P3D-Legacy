Public Class SummaryScreen
    ...
    Private Sub DrawMain()
        ...
        SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.type", Nothing, "Type"), New Vector2(DeltaX + 10, DeltaY + 330 + 4), New Color(255, 255, 255, CInt(220 * _interfaceFade)))
        SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.item", Nothing, "Item"), New Vector2(DeltaX + 10, DeltaY + 362 + 4), New Color(255, 255, 255, CInt(220 * _interfaceFade)))
        SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.nature", Nothing, "Nature"), New Vector2(DeltaX + 10, DeltaY + 394 + 4), New Color(255, 255, 255, CInt(220 * _interfaceFade)))
        SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.dexno", Nothing, "Dex No."), New Vector2(DeltaX + 10, DeltaY + 426 + 4), New Color(255, 255, 255, CInt(220 * _interfaceFade)))
        ...
        SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.idno", Nothing, "ID No."), New Vector2(DeltaX + 10, DeltaY + 490 + 4), New Color(255, 255, 255, CInt(220 * _interfaceFade)))
    ...
    Private Sub DrawPage1()
        With GetPokemon()
            ...
            SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.ability", Nothing, "Ability"), New Vector2(DeltaX + 360, DeltaY + 366 - 64), New Color(255, 255, 255, CInt(220 * _interfaceFade * _pageFade)))
            ...
            SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.catch_method", Nothing, "Catch Method"), New Vector2(DeltaX + 360, DeltaY + 366 + 64), New Color(255, 255, 255, CInt(220 * _interfaceFade * _pageFade)))
            ...
            'EXP:
            Canvas.DrawRectangle(New Rectangle(DeltaX + 734 - 12, DeltaY + 362 + 64, 300 + 24, 32), New Color(0, 0, 0, CInt(100 * _interfaceFade * _pageFade)))
            SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.exp_points", Nothing, "Exp. Points"), New Vector2(DeltaX + 744 - 12, DeltaY + 366 + 64), New Color(255, 255, 255, CInt(220 * _interfaceFade * _pageFade)))
            ...
            If .Level < CInt(GameModeManager.GetGameRuleValue("MaxLevel", "100")) Then
                ...
                SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.to_next_lv", Nothing, "To Next Lv."), New Vector2(DeltaX + 744 - 12, DeltaY + 398 + 64), New Color(255, 255, 255, CInt(220 * _interfaceFade * _pageFade)))
    ...
    Private Sub DrawPage2()
        With GetPokemon()
            ...
            'Type:
            SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.type", Nothing, "Type:"), New Vector2(DeltaX + 710, DeltaY + 80), New Color(255, 255, 255, CInt(220 * _interfaceFade * _pageFade * _moveFade)))
            ...
            'Stats:
            SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.category", Nothing, "Category:"), New Vector2(DeltaX + 710, DeltaY + 144), New Color(255, 255, 255, CInt(220 * _interfaceFade * _pageFade * _moveFade)))
            ...
            SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.power", Nothing, "Power:"), New Vector2(DeltaX + 710, DeltaY + 176), New Color(255, 255, 255, CInt(220 * _interfaceFade * _pageFade * _moveFade)))
            ...
            SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.accuracy", Nothing, "Accuracy:"), New Vector2(DeltaX + 710, DeltaY + 208), New Color(255, 255, 255, CInt(220 * _interfaceFade * _pageFade * _moveFade)))
    ...
    Private Sub DrawEgg()
        ...
        SpriteBatch.DrawString(FontManager.ChatFont, Localization.Translate("summaryscreen.egg_watch", Nothing, "The Egg Watch"), New Vector2(DeltaX + 410, DeltaY + 80), New Color(255, 255, 255, CInt(220 * _fadeIn)))
