...
#Region "Initialize"
        ...
        Private Shared Sub DoItem()
            ...
            r(New ScriptCommand("Item", "Repel", {New ScriptArgument("ItemOrStepAmount", ScriptArgument.ArgumentTypes.Str),
                                                    New ScriptArgument("RepelItemID", ScriptArgument.ArgumentTypes.Str, {"20", "42", "43"}, True)}.ToList(), "Adds the amount of the first argument to the Repel steps of the player. If the first argument is ""Item"" instead of a number, the amount of repel steps from the item with the ID of the second argument will be used."))
        ...
        Private Shared Sub DoScreen()
            ...
            r(New ScriptCommand("screen", "teachmoves", {New ScriptArgument("PokémonIndex", ScriptArgument.ArgumentTypes.Int),
            ...
            r(New ScriptCommand("screen", "showPokémon", {New ScriptArgument("PokémonID", ScriptArgument.ArgumentTypes.Int),
        ...
        Private Shared Sub DoSystem()
            ...
            r(New ScriptCommand("system", "startswith", "bool", {New ScriptArgument("DoesThisStartWith", ScriptArgument.ArgumentTypes.Str), New ScriptArgument("StringsToCheck", ScriptArgument.ArgumentTypes.Str)}.ToList(), "Returns true if the argument ""DoesThisStartWith"" starts with one of given strings to check (separated by ;).", ",", True))
            r(New ScriptCommand("system", "contains", "bool", {New ScriptArgument("DoesThisContain", ScriptArgument.ArgumentTypes.Str), New ScriptArgument("StringsToCheck", ScriptArgument.ArgumentTypes.Str)}.ToList(), "Returns true if the argument ""DoesThisContain"" contains one of given strings to check (separated by ;).", ",", True))
        ...
        Private Shared Sub DoPokedex()
            ...
            r(New ScriptCommand("pokedex", "Pokémoncaught", "bool", {New ScriptArgument("ID", ScriptArgument.ArgumentTypes.Str)}.ToList(), "Returns if the specified Pokémon has been caught.", "", True))
            r(New ScriptCommand("pokedex", "Pokémonseen", "bool", {New ScriptArgument("ID", ScriptArgument.ArgumentTypes.Str)}.ToList(), "Returns if the specified Pokémon has been seen.", "", True))
        ...
        Private Shared Sub DoPokemon()
            ' Commands:
            r(New ScriptCommand("Pokemon", "Cry", {New ScriptArgument("PokémonID", ScriptArgument.ArgumentTypes.Str)}.ToList(), "Plays the cry of the given Pokémon."))
            r(New ScriptCommand("Pokemon", "Remove", {New ScriptArgument("PokémonIndex", ScriptArgument.ArgumentTypes.Int)}.ToList(), "Removes the Pokémon at the given index from the player's party."))
            ...
            r(New ScriptCommand("Pokemon", "Add", {New ScriptArgument("PokémonID", ScriptArgument.ArgumentTypes.Str),
                                               New ScriptArgument("Level", ScriptArgument.ArgumentTypes.Int),
                                               ...
                                               New ScriptArgument("OriginalTrainer", ScriptArgument.ArgumentTypes.Str, True, "<Player.Name>")}.ToList(), "Adds the Pokémon with the given arguments to the player's party."))
            ...
            r(New ScriptCommand("Pokemon", "Clear", "Removes all Pokémon from the player's party."))
            ...
            r(New ScriptCommand("Pokemon", "Heal", {New ScriptArgument("PokémonIndicies", ScriptArgument.ArgumentTypes.IntArr, True, "")}.ToList(), "Heals the given Pokémon."))
            ...
            r(New ScriptCommand("Pokemon", "AddFriendship", {New ScriptArgument("PokémonIndex", ScriptArgument.ArgumentTypes.Str),
                                                         New ScriptArgument("Amount", ScriptArgument.ArgumentTypes.Int)}.ToList(), "Adds the given amount to the friendship value of a Pokémon in the player's party."))
            ...
            r(New ScriptCommand("Pokemon", "LearnAttack", {New ScriptArgument("PokémonIndex", ScriptArgument.ArgumentTypes.Int),
                                                       New ScriptArgument("AttackID", ScriptArgument.ArgumentTypes.Int)}.ToList(), "Teaches the given attack to the given party member."))
            ...
            r(New ScriptCommand("Pokemon", "setability", {New ScriptArgument("PokémonIndex", ScriptArgument.ArgumentTypes.Int),
                                                       New ScriptArgument("abilityID", ScriptArgument.ArgumentTypes.Int, {"0-310"})}.ToList(), "Sets the Ability of a Pokémon in the player's party."))
            r(New ScriptCommand("Pokemon", "setability", {New ScriptArgument("PokémonIndex", ScriptArgument.ArgumentTypes.Int),
                                                       New ScriptArgument("abilitySlot", ScriptArgument.ArgumentTypes.Str, {"A,B,C,H"})}.ToList(), "Sets the Ability of a Pokémon in the player's party to the desired Ability Slot (Normal = A or B, Event = C, Hidden = H)."))
            ...
            r(New ScriptCommand("Pokemon", "nickname", "str", {New ScriptArgument("PokémonIndex", ScriptArgument.ArgumentTypes.Int)}.ToList(), "Returns the nickname of a Pokémon in the player's party or ""Egg"" if it's in an egg.", ",", True))
            ...
            r(New ScriptCommand("Pokemon", "name", "str", {New ScriptArgument("PokémonIndex", ScriptArgument.ArgumentTypes.Int)}.ToList(), "Returns the actual name of a Pokémon in the player's party, regardless if the Pokémon has a nickname or is in an egg (including form prefixes and suffixes).", ",", True))
            r(New ScriptCommand("Pokemon", "originalname", "str", {New ScriptArgument("PokémonIndex", ScriptArgument.ArgumentTypes.Int)}.ToList(), "Returns the English name of a Pokémon in the player's party (including form prefixes and suffixes).", ",", True))
            ...
            r(New ScriptCommand("Pokemon", "ability", "int", {New ScriptArgument("PokémonIndex", ScriptArgument.ArgumentTypes.Int)}.ToList(), "Returns the Ability ID of the given Pokémon.", ",", True))
            r(New ScriptCommand("Pokemon", "abilityslot", "str", {New ScriptArgument("PokémonIndex", ScriptArgument.ArgumentTypes.Int)}.ToList(), "Returns the Ability Slot of the Ability of the given Pokémon (A, B, C or H). Returns the Ability ID of the Pokémon if it has an Ability not defined in its data file.", ",", True))
