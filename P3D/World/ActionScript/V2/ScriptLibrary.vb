...
#Region "Initialize"
        ...
        Private Shared Sub DoBattle()
            ...
            r(New ScriptCommand("Battle", "SetVar", {New ScriptArgument("VarName", ScriptArgument.ArgumentTypes.Str, {"CanUseBag", "CanRun", "CanCatch", "CanBlackout", "CanReceiveExp", "CanUseItems", "FrontierTrainer", "DiveBattle", "InverseBattle, CustomBattleMusic, HiddenAbilityChance"}),
