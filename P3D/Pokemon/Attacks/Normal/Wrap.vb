Namespace BattleSystem.Moves.Normal
    ...
    Public Class Wrap
        ...
        Public Overrides Sub InternalOpponentPokemonMoveAnimation(ByVal BattleScreen As BattleScreen, ByVal BattleFlip As Boolean, ByVal CurrentPokemon As Pokemon, ByVal CurrentEntity As NPC)
            ...
            MoveAnimation.AnimationScale(Nothing, False, 0.75F, 1.0F, 0.75F, 0.02F, 5, 0)
            MoveAnimation.AnimationScale(WrapEntity, False, 0.75F, 0.5F, 0.75F, 0.02F, 5, 0)
            MoveAnimation.AnimationScale(Nothing, False, 1.0F, 1.0F, 1.0F, 0.04F, 7, 0)
            MoveAnimation.AnimationScale(WrapEntity, False, 1.0F, 0.5F, 1.0F, 0.04F, 7, 0)
            MoveAnimation.AnimationScale(Nothing, False, 0.75F, 1.0F, 0.75F, 0.02F, 9, 0)
            MoveAnimation.AnimationScale(WrapEntity, False, 0.75F, 0.5F, 0.75F, 0.02F, 9, 0)
            MoveAnimation.AnimationScale(Nothing, False, 1.0F, 1.0F, 1.0F, 0.04F, 11, 0)
