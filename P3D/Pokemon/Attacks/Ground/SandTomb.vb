    ...
    Public Class SandTomb
        ...
        Public Overrides Sub MoveHits(own As Boolean, BattleScreen As BattleScreen)
            ...
            If Not p.Item Is Nothing Then
                If p.Item.Name.ToLower(Globalization.CultureInfo.InvariantCulture) = "grip claw" And BattleScreen.FieldEffects.CanUseItem(own) = True And BattleScreen.FieldEffects.CanUseOwnItem(own, BattleScreen) = True Then
                    turns = 5
                End If
            End If
